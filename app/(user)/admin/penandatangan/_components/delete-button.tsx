...
import { deletePenandatangan } from "@/lib/actions";
import { Loader2 } from "lucide-react";
import { useToast } from "@/components/ui/use-toast";

const DeletePenandatanganButton = ({ id }: { id: string }) => {
  ...
  return (
    <AlertDialog open={alertOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Hapus Data Penandatangan?</AlertDialogTitle>
          <AlertDialogDescription>
...
export default DeletePenandatanganButton;
