...
function GeneralLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <div className="hidden sm:block bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-primary/20 to-transparent rounded-full h-80 w-80 z-0 blur-3xl absolute top-0 -right-24"></div>
